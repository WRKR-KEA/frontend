...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const pageTitle = (() => {
    if (pathname === "/user/home") return "홈";
    if (pathname.startsWith("/user/myticket")) return "티켓 조회";
    if (pathname === "/user/createticket") return "티켓 생성";
    if (pathname === "/user/mypage") return "계정";
    if (pathname.startsWith("/manager/monitoring")) return "통계";
    return "페이지 없음";
  })();
