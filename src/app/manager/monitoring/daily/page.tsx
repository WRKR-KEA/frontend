...
export default function DailyMonitoring() {
        ...
        chart: {
          ...
          events: {
            dataPointSelection: async (event, chartContext, { dataPointIndex }) => {
              ...
              const selectedName = updatedLabels[dataPointIndex];  // 선택된 카테고리
  ...
  return (
    <div className="flex flex-col gap-8 p-8">
      ...
      <h2 className="text-md font-semibold">카테고리별 티켓 요약</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">

        <div className="bg-white p-6 rounded-lg shadow-md">

          <h4 className="text-lg text-gray-800 mb-4">카테고리 별 요청된 티켓</h4>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          {
            firstCategoryDonutChartSeries.length > 0 ? (
              <Chart options={secondCategoryDonutChartOptions}
                     series={secondCategoryDonutChartSeries}
