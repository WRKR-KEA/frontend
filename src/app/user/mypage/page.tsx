            ...
            <div className="space-y-2">
              {isEditing ? (
                <input
                  ...
                  className="text-2xl font-bold text-gray-800 border-b-2 border-gray-300 focus:outline-none h-10 pb-2"
                />
              ) : (
                ...
                {isEditing ? (
                  <>
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full border-b-2 py-0 focus:outline-none h-10 ${errors[field.name] ? 'border-red-500' : 'border-gray-300'}`}
                    />
                    {errors[field.name] && (
