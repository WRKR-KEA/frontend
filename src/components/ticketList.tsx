...
export function TicketList({ maxTicketsToShow, page,  status, handler, requester }: TicketListProps ) {
  const tickets = [
    ...
    { "id": "AAA000010", "status": "작업반려", "title": "서비스 장애 복구 요청", "requester": "춘식이", "requestDate": "2025.01.10", "updateDate": "2025.01.23", "handler": "네오" },
    ...
    { "id": "AAA000015", "status": "작업반려", "title": "보안 설정 변경 요청", "requester": "춘식이", "requestDate": "2025.01.15", "updateDate": "2025.01.28", "handler": "라이언" },
    ...
    { "id": "AAA000020", "status": "작업반려", "title": "서버 로그 분석 요청", "requester": "춘식이", "requestDate": "2025.01.20", "updateDate": "2025.02.02", "handler": "무지" },
    ...
    { "id": "AAA000025", "status": "작업반려", "title": "네트워크 설정 변경 요청", "requester": "춘식이", "requestDate": "2025.01.25", "updateDate": "2025.02.07", "handler": "프로도" },
    ...
    { "id": "AAA000030", "status": "작업반려", "title": "사용자 권한 수정 요청", "requester": "춘식이", "requestDate": "2025.01.30", "updateDate": "2025.02.12", "handler": "어피치" }
  ];
