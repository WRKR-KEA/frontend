...
export function TicketList_Manager({
  ...
  const tickets = [
    ...
    { "id": "AAA000003", "status": "작업완료", "title": "하드웨어 장애 해결 요청", "requester": "춘식사", "requestDate": "2025.01.03", "updateDate": "2025.01.16", "handler": "네오" },
    { "id": "AAA000004", "status": "작업진행", "title": "권한 요청", "requester": "춘식오", "requestDate": "2025.01.04", "updateDate": "2025.01.17", "handler": "프로도" },
    { "id": "AAA000005", "status": "작업진행", "title": "서버 재부팅 요청", "requester": "춘식일", "requestDate": "2025.01.05", "updateDate": "2025.01.18", "handler": "튜브" },
    { "id": "AAA000006", "status": "작업완료", "title": "VM이 느려요.", "requester": "오레오", "requestDate": "2025.01.06", "updateDate": "2025.01.19", "handler": "무지" },
    { "id": "AAA000007", "status": "작업진행", "title": "디스크 용량 부족 해결 요청", "requester": "춘식이", "requestDate": "2025.01.07", "updateDate": "2025.01.20", "handler": "제이지" },
    { "id": "AAA000008", "status": "작업진행", "title": "파일 복구 요청", "requester": "오레오", "requestDate": "2025.01.08", "updateDate": "2025.01.21", "handler": "라이언" },
    { "id": "AAA000009", "status": "작업완료", "title": "서버 모니터링 요청", "requester": "네오", "requestDate": "2025.01.09", "updateDate": "2025.01.22", "handler": "어피치" },
    { "id": "AAA000010", "status": "반려", "title": "서비스 장애 복구 요청", "requester": "춘식일", "requestDate": "2025.01.10", "updateDate": "2025.01.23", "handler": "네오" },
    ...
    { "id": "AAA000023", "status": "작업완료", "title": "하드웨어 교체 요청", "requester": "프로도", "requestDate": "2025.01.23", "updateDate": "2025.02.05", "handler": "어피치" },
